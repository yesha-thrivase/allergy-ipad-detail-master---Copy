$(function () {
	const sequence = [{
		name: 'Allergy_Home', // ID of the slide as written in parameters.xml
	...
	function createBottomMenu() {
		...
		<div class="flex flex-row h-full">
            ...
            <div class="goals" onclick="window.parent.navigateToSequence('Allergy_Goals')" data-prevent-tap="true" style="width:13.3%"></div>
            <div class="guidelines" onclick="window.parent.navigateToSequence('Allergy_Guidelines')" data-prevent-tap="true" style="width:12%"></div>
            <div class="ait" onclick="window.parent.navigateToSequence('Allergy_AIT')" data-prevent-tap="true" style="width:12.6%"></div>
			<div class="product-information " onclick="window.parent.navigateToSequence('PAL_Spec_PI')" data-prevent-tap="true" style="width:6.8%"></div>
