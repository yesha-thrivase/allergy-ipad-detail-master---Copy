$(function () {
	const sequence = [{
		name: 'Allergy_Guidelines_ASCIA', // ID of the slide as written in parameters.xml
		...
		name: 'Allergy_Guidelines_ASCIA_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
	...
	{
		name: 'Allergy_Guidelines_GINA', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		...
		name: 'Allergy_Guidelines_GINA_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: null, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo: 'previous',
	},{
		name: 'Allergy_Guidelines_Typical', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		...
		name: 'Allergy_Guidelines_Typical_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: null, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo: 'previous',
	},{
	    name: 'Allergy_Guidelines_UAD', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		...
		name: 'Allergy_Guidelines_UAD_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: null, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo: 'previous',	
	}
	...
	$('#ginaRef').on('click', function(){
		slideTo(3);
	})

	$('#typRef').on('click', function(){
		slideTo(5);
	})

	$('#uadRef').on('click', function(){
		slideTo(7);
	})
