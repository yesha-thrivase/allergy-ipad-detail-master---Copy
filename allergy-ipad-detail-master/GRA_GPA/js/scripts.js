$(function () {
	const sequence = [{
		name: 'GRA_GPA_Home', // ID of the slide as written in parameters.xml
		...
		name: 'GRA_GPA_Home_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		...
		name: 'GRA_GPA_Cross', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		...
		name: 'GRA_GPA_Cross_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: null, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo: 'previous',
	}	
	...
	function createBottomMenu() {
		...
		<div class="flex flex-row h-full">
            ...
            <div class="grasspollenallergy" onclick="window.parent.navigateToSequence('GRA_GPA')" data-prevent-tap="true" style="width:21.3%"></div>
            <div class="grazax" onclick="window.parent.navigateToSequence('GRA_Grazax')" data-prevent-tap="true" style="width:12%"></div>
			<div class="summary" onclick="window.parent.navigateToSequence('GRA_Summary')" data-prevent-tap="true" style="width:17%"></div>
            <div class="product-information " onclick="window.parent.navigateToSequence('GRA_PI')" data-prevent-tap="true" style="width:6.8%"></div>
