$(function () {
	const sequence = [{
		name: 'ACA_Acarizax_Home', // ID of the slide as written in parameters.xml
		...
		name: 'ACA_Acarizax_Home_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		...
		name: 'ACA_Acarizax_Improve_RQLQ', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: 3, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:0,
	},{
		name: 'ACA_Acarizax_Improve_RQLQ_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: null, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:'previous',
	},{
		name: 'ACA_Acarizax_Improve_Sleep_1', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: 6, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:'previous',
	},{
		name: 'ACA_Acarizax_Improve_Sleep_2', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: 6, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:'previous',
	},{
		name: 'ACA_Acarizax_Improve_Sleep_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: null, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:'previous',
	},{
		name: 'ACA_Acarizax_Fewer_Nasal', // ID of the slide as written in parameters.xml
		studyDesign: 9, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		...
		name: 'ACA_Acarizax_Fewer_Nasal_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		...
		name: 'ACA_Acarizax_Demoly_SD_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: 2, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:'previous',
	},{
		name: 'ACA_Acarizax_Halved_NS', // ID of the slide as written in parameters.xml
		studyDesign: 12, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		...
		name: 'ACA_Acarizax_Halved_NS_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: 2, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:'previous',
	},{
		name: 'ACA_Acarizax_Nolte_SD', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: 13, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:'previous',
	},{
		name: 'ACA_Acarizax_Nolte_SD_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: 2, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:'previous',
	},{
		name: 'ACA_Acarizax_Adolescent', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: 15, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:0,
	},{
		name: 'ACA_Acarizax_Adolescent_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: null, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:'previous',
	},{
		name: 'ACA_Acarizax_Flare_ups', // ID of the slide as written in parameters.xml
		...
		name: 'ACA_Acarizax_Flare_ups_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: null, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:'previous',
	},{
		name: 'ACA_Acarizax_Matsuoka_SD', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: null, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:0,
	},{
		name: 'ACA_Acarizax_Protection', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		...
		name: 'ACA_Acarizax_Protection_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: 2, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:'previous',
	},{
		name: 'ACA_Acarizax_Exacerbations', // ID of the slide as written in parameters.xml
		studyDesign: 23, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: 22, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:'previous',
	},{
		name: 'ACA_Acarizax_Exacerbations_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: null, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:'previous',
	},{
		name: 'ACA_Acarizax_Virchow_SD', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: 24, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:'previous',
	},{
		name: 'ACA_Acarizax_Virchow_SD_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: null, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:'previous',
	},{
		name: 'ACA_Acarizax_Eligible', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: 26, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:0,
	},{
		name: 'ACA_Acarizax_Eligible_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: null, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:'previous',
	}
	...
	$('#rqlqNav').on('click', function(){
		slideTo(2);
	})

	$('#rqlqRef').on('click', function(){
		slideTo(3);
	})

	$('#rqlqSleep').on('click', function(){
		slideTo(4);
	})

	
	$('#nasNav').on('click', function(){
		slideTo(7);
	})

	$('#halNav').on('click', function(){
		slideTo(10);
	})
	
	$('#adoNav').on('click', function(){
		slideTo(14);
	})

	$('#flaNav').on('click', function(){
		slideTo(16);
	})

	
	$('#exaNav').on('click', function(){
		slideTo(19);
	})

	$('#proNav').on('click', function(){
		slideTo(21);
	})

	$('#eliNav').on('click', function(){
		slideTo(25);
	})
